...
function GoogleAuthentication() {
    ...
    return (
        <div className='flex flex-col justify-center h-screen bg-[#f2f1f7] p-2'>
            <ToastContainer />
            ...
            w-full  p-1 rounded-[4px]'>Google <FcGoogle className='text-[40px]' /></button>
                        <h1 className='text-[25px]'>OR</h1>
                        <form onSubmit={handleSignUpMicrosoft} className='flex flex-col gap-4 w-full '>
            ...
            border-[1px] border-black h-12 w-12 rounded-[4px] ' onMouseEnter={handleShow} onMouseLeave={handleShow} />
                            ...
                            <button type='submit' className='cursor-pointer text-[20px] border-black border-[1px] hover:bg-[#efefef]  w-full p-2 rounded-[4px]'>Login</button>
                        </form>
